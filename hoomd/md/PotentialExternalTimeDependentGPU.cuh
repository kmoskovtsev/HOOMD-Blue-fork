...
/*! \file PotentialExternalTimeDependentGPU.cuh
    \brief Defines templated GPU kernel code for calculating the external time-dependent forces.
*/

#ifndef __POTENTIAL_EXTERNAL_TIME_DEPENDENT_GPU_CUH__
#define __POTENTIAL_EXTERNAL_TIME_DEPENDENT_GPU_CUH__
...
#ifdef NVCC
//! Kernel for calculating external forces that are time dependent
...
__global__ void gpu_compute_external_forces_kernel(Scalar4 *d_force,
    ...
    evaluator eval(Xi, box, params[typei], timestep, field);
